...
<?php 
        ...
        //query connection
        $query = 'SELECT * from employee_office limit '.$first_page_results. ',' .$number_per_page;

        $result = mysqli_query($conn,$query);

        $employee_table = mysqli_fetch_all($result, MYSQLI_ASSOC);
                            ...
                            <div class="card-header ">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    adress varchar(100) -->
                                        ...
                                        <tbody>
                                            <?php foreach ($employee_table as $employee_col): ?>
                                            <tr>
                                                <td><?php echo $employee_col['id'] ?></td>
                                                <td><?php echo $employee_col['lastname'] ?></td>
                                                <td><?php echo $employee_col['firstname'] ?></td>
                                                <td><?php echo $employee_col['name'] ?></td>
                                                <td><?php echo $employee_col['address'] ?></td>
                                                <td>
                                                    <a href="employee_edit.php?id=<?php echo $employee_col['id']; ?>">
