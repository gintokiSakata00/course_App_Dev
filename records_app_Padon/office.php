...
<?php 
        ...
        $query = 'SELECT * FROM office limit '.$first_page_results. ',' .$number_per_page; 
        $result = mysqli_query($conn,$query);
        $offices_table = mysqli_fetch_all($result, MYSQLI_ASSOC);
                            ...
                            <div class="card-header ">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    postal int -->
                                        ...
                                        <tbody>
                                            <?php foreach ($offices_table as $office_col): ?>
                                            <tr>
                                                <td><?php echo $office_col['id'] ?></td>
                                                <td><?php echo $office_col['name'] ?></td>
                                                <td><?php echo $office_col['contactnum'] ?></td>
                                                <td><?php echo $office_col['email'] ?></td>
                                                <td><?php echo $office_col['address'] ?></td>
                                                <td><?php echo $office_col['city'] ?></td>
                                                <td><?php echo $office_col['country'] ?></td>
                                                <td><?php echo $office_col['postal'] ?></td>
                                                <td>
                                                    <a href="office_edit.php?id=<?php echo $office_col['id']; ?>">
