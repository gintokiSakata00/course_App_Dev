 ...
 include('includes/sidebar.php'); ?>
        ...
        <div class="main-panel">
            ...
            if(isset($_POST['submit'])){
                ...
                //create insert query
                $query = "INSERT INTO record_app.transaction(employee_id,office_id,datelog,action, remarks,documentcode) 
                values('$employee_id','$office_id','".date("Y-m-d h:i:s")."','$action', '$remarks','$documentcode')";
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <select name="employee_id" class="form-control">
                                                        ...
                                                        <?php
                                                            $query =  "SELECT id, concat(lastname, ' ', firstname) as name  from record_app.employee";
                                            ...
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <option value="">SELECT</option>
                                                    <?PHP
                                                            $query = "SELECT id, name FROM record_app.office";
                                                            $result = mysqli_query($conn, $query);
                                                            while ($row = mysqli_fetch_array($result)){
                                                                echo "<option value=".$row['id'].">".$row['name']."</option>";
                                                            }
