                    ...
                    <div class="col-sm-12 col-xl-9">
                        <div class="bg-secondary text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">TASK 1 HORIZONTAL BAR</h6>
                                <a href="">EXPENSIVE PRODUCTS</a>
                            </div>
                            <canvas id="expensive_Chart"></canvas>
                        </div>
          
<?php
                               
                                $query = 'SELECT productName AS "Products", UnitPrice AS "Price"
                                          FROM products ORDER BY UnitPrice DESC LIMIT 5';
...
<script>
                                ...
                                const chartShippers = new Chart(
                                  document.getElementById('expensive_Chart'),
                                  config
                                );
                              </script>
